...
From the ``django-threejs`` folder, launch::
...
``threejs`` requires the following settings in order to work as expected.
...
* ``DATABASE_URL`` (default: ``postgres://devel:123456@127.0.0.1:5432/threejs``)
